 ...
 * {@hide}
 */
public class tomatoRIL extends RIL implements CommandsInterface {
    ...
    public tomatoRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public tomatoRIL(Context context, int networkMode, int cdmaSubscription) {
